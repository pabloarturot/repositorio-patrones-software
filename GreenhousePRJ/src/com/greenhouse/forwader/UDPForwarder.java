	    ...
	    public void send(Message message, NetworkInfoDTO networkInfoDTO) throws IOException {
			...
			case INIT_COMM:
				 packet = new DatagramPacket(
			        		byteArray,
			        		byteArray.length,
			                InetAddress.getByName(networkInfoDTO.getServerHost()),
			                networkInfoDTO.getServerPort());
				 DatagramSocket datagramSocket = new DatagramSocket(networkInfoDTO.getClientPort());
